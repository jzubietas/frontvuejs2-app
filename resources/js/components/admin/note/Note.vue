<template>
  <div class="componentwarpper">
    <div class="warpper">
      <div class="px-5 d-flex justify-content-between">
        ...
        <a :href="'/admin/notes/create'">
          <div class="d-inline-block text-3">
            Agregar Nuevos Notas <i class="fas fa-arrow-right"></i>
          </div>
        </a>
      </div>
      ...
      <div class="px-5 mt-5">
        ...
        <div class="mt-5">
          ...
          <div v-if="notes == ''" class="text-7 w-100 text-center">
            <img
    ...
    ></confirm-modal>
    <note-details
      v-if="toggleNoteDetails"
      :note="selectedNote"
      :seller_ratings="selected_seller_ratings"
      @closeNoteDetails="closeDetails"
    ></note-details>
  </div>
</template>
...
import NoteDetails from "./subcomponents/Details.vue";
...
export default {
  ...
  methods: {
    ...
    showDetails(note) {
      ...
      this.toggleNoteDetails = true;
      document.body.style.overflow = "hidden";
    },
    closeDetails() {
      this.selectedNote = "";
      this.toggleNoteDetails = false;
